...
#             'hip_knee_ankle_angle',      # Hip-knee-ankle force transfer and lower body stability
#             'shoulder_hip_knee_angle',   # Upper body angle change, preparation-shooting flow
#             'shoulder_elbow_wrist_angle', # Release timing and direction
#             'elbow_shoulder_hip_angle',  # Release height position
#             'ball_to_eye_vertical_distance', # Release preparation-start position
#             'elbow_to_eye_height'        # Hand height judgment during release
#         ]
        
#         # Phase-specific features
#         # Loading phase specific features (dip, squat, ready posture)
#         self.loading_features = [
#             'foot_rim_difference',       # Foot direction difference to rim
#             'ball_hip_vertical_distance', # Ball-hip vertical distance (measuring dip)
#             'hip_knee_ankle_angle',      # Hip-knee-ankle angle (squat posture)
#             'shoulder_hip_knee_angle',   # Shoulder-hip-knee angle (upper body preparation)
#             'hip_shoulder_incline_angle', # Hip-shoulder incline angle
#             'ankle_width_vs_shoulder_width', # Ankle width vs shoulder width (stance)
#         ]
        
#         # Rising phase specific features (windup, rising, set point)
#         self.rising_features = [
#             'windup_trajectory_length',  # Windup trajectory length
#             'dip_to_setpoint_time',      # Time from dip to set point
#             'shoulder_elbow_wrist_angle', # Shoulder-elbow-wrist angle (set point preparation)
#             'elbow_shoulder_hip_angle',   # Elbow-shoulder-hip angle (rising posture)
#             'ball_to_eye_vertical_distance', # Ball-eye vertical distance (set point height)
#             'upward_movement_after_setpoint' # Upward movement after set point
#         ]
...
#             'shoulder_elbow_wrist_angle', # Shoulder-elbow-wrist angle
#             'elbow_shoulder_hip_angle',   # Elbow-shoulder-hip angle
#             'hip_knee_ankle_angle',       # Hip-knee-ankle angle
#             'hip_shoulder_incline_angle', # Hip-shoulder incline angle
#             'ball_to_eye_distance',       # Ball-eye distance
#             'elbow_to_eye_height'         # Elbow-eye height
#         ]
        
#         self.follow_through_features = [
#             'max_wrist_elbow_shoulder_angle', # Maximum wrist-elbow-shoulder angle
#             'elbow_to_eye_height_at_max_angle', # Elbow-eye height at maximum angle
#             'time_to_max_angle_from_release',   # Time from release to maximum angle
#             'hip_knee_ankle_angle_at_max',      # Hip-knee-ankle angle at maximum angle
#             'leg_kick_angle',                    # Leg kick angle
#             'one_motion_vs_two_motion'          # One motion vs two motion determination
#         ]
...
#         """
#         Extract loading phase specific features (dip, squat, ready posture).
#         """
#         pose = frame.get("normalized_pose", {})
#         ball = frame.get("normalized_ball", {})
...
#         # Loading specific features (dip, squat, ready posture)
#         if hip and ball:
...
#         """
#         Extract rising phase specific features (windup, rising, set point).
#         """
#         pose = frame.get("normalized_pose", {})
#         ball = frame.get("normalized_ball", {})
...
#         # Rising specific features (windup, rising, set point)
